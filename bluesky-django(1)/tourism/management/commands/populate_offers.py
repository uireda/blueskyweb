    ...
    def handle(self, *args, **options):
        ...
        offers_data = [
            ...
            },
            {
                ...
                'destination': destinations[1] if len(destinations) > 1 else destinations[0],  # Grèce
            ...
            },
            {
                ...
                'destination': destinations[2] if len(destinations) > 2 else destinations[0],  # Espagne
                'offer_type': 'family',
            ...
            },
            {
                ...
                'destination': destinations[4] if len(destinations) > 4 else destinations[0],  # Canaries
                'offer_type': 'group',
            ...
            },
            {
                ...
                'destination': destinations[5] if len(destinations) > 5 else destinations[0],  # Djerba
                'offer_type': 'senior',
